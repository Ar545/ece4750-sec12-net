...
#include "obj_dir_NetRouterSwitchUnit__p_msg_nbits_44/VNetRouterSwitchUnit__p_msg_nbits_44.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_NetRouterSwitchUnit__p_msg_nbits_44/VNetRouterSwitchUnit__p_msg_nbits_44__Syms.h"
#include "svdpi.h"
#endif
...
VNetRouterSwitchUnit__p_msg_nbits_44_t * create_model( const char *vcd_filename ) {

  VNetRouterSwitchUnit__p_msg_nbits_44_t * m;
  VNetRouterSwitchUnit__p_msg_nbits_44   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VNetRouterSwitchUnit__p_msg_nbits_44_t *) malloc( sizeof(VNetRouterSwitchUnit__p_msg_nbits_44_t) );
  model = new VNetRouterSwitchUnit__p_msg_nbits_44();
  ...
  m->clk = &model->clk;
  m->reset = &model->reset;
  m->istream0_msg = &model->istream0_msg;
  m->istream0_rdy = &model->istream0_rdy;
  m->istream0_val = &model->istream0_val;
  m->istream1_msg = &model->istream1_msg;
  m->istream1_rdy = &model->istream1_rdy;
  m->istream1_val = &model->istream1_val;
  m->istream2_msg = &model->istream2_msg;
  m->istream2_rdy = &model->istream2_rdy;
  m->istream2_val = &model->istream2_val;
...
void destroy_model( VNetRouterSwitchUnit__p_msg_nbits_44_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VNetRouterSwitchUnit__p_msg_nbits_44 * model = (VNetRouterSwitchUnit__p_msg_nbits_44 *) m->model;
...
void comb_eval( VNetRouterSwitchUnit__p_msg_nbits_44_t * m ) {
...
void seq_eval( VNetRouterSwitchUnit__p_msg_nbits_44_t * m ) {
...
#if VLINETRACE
void trace( VNetRouterSwitchUnit__p_msg_nbits_44_t * m, char* str ) {
